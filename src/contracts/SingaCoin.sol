...
contract SingaCoin {
    string public name = 'SingaCoin';
    string public symbol = 'SGDC';
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool isSuccess) {
        ...
        // Look at the approve function above. Now, the third party (_spender) is the msg.sender. 
        ...
        // deduct balances for the sender
